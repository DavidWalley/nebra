...
//  cd ~/Desktop/CODE/nebra && haxe --neko TEMP_neko.n --main ToolChain_MakeDataFiles && neko TEMP_neko.n && sleep 1 && wmctrl -a 'Stellarium 24.3' # Run this file and switch to open STELLARIUM window.
...
{/////////////////////////////////////////////////////////////////////////////////////////////////////////>
  ...
  var                   _sPathMoney       :String               = "/home/dave/Desktop/CODE/nebra/";     //> ???Hard-coded? Money code directory.

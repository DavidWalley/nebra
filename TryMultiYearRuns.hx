...
//////////////////////////////////////////////////////////////////////////////////////////////////////////>
 ...
 function               New_ReadData(/////////////////////////////////////////////////////////////////////>
  ...
  for( y in  400... 500 ){   New_ReadMapasDataOfFile(      '0400/table017_'+ y +'.csv' );   }           //> For a century... Get data from each file, put in global table.
  for( y in  500... 600 ){   New_ReadMapasDataOfFile(      '0500/table017_'+ y +'.csv' );   }           //> For a century... Get data from each file, put in global table.
  for( y in  600... 700 ){   New_ReadMapasDataOfFile(      '0600/table017_'+ y +'.csv' );   }           //> For a century... Get data from each file, put in global table.
  for( y in  700... 800 ){   New_ReadMapasDataOfFile(      '0700/table017_'+ y +'.csv' );   }           //> For a century... Get data from each file, put in global table.
